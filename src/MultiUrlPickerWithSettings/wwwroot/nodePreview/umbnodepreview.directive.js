...
(function () {
    ...
    function NodePreviewDirective(userService) {
        ...
        var directive = {
            restrict: 'E',
            replace: true,
            templateUrl: '/App_Plugins/MultiUrlPickerWithSettings/nodePreview/umb-node-preview.html',
            scope: {
                icon: "=?",
                name: "=",
                alias: "=?",
    ...
    angular.module('umbraco.directives').directive('yuzuNodePreview', NodePreviewDirective);
