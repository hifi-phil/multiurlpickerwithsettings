...
public class MultiUrlPickerWithSettingsValueEditor : DataValueEditor, IDataValueReference
{
    ...
    public MultiUrlPickerWithSettingsValueEditor(
    ...
    public override object? ToEditor(IProperty property, string? culture = null, string? segment = null)
    {
        ...
        try
        {
            ...
            var result = new List<LinkDisplayWithSettings>();
            if (links is null)
            {
                return result;
            }
            ...
            foreach (LinkDto dto in links)
            {
                ...
                result.Add(new LinkDisplayWithSettings
                {
                    Icon = icon,
                    Name = dto.Name,
                    Target = dto.Target,
                    ...
                    Settings = JsonConvert.DeserializeObject(dto.Settings)
                });
            }
    ...
    public override object? FromEditor(ContentPropertyData editorValue, object? currentValue)
    {
        ...
        try
        {
            List<LinkDisplayWithSettings>? links = JsonConvert.DeserializeObject<List<LinkDisplayWithSettings>>(value);
            if (links?.Count == 0)
            {
                return null;
            }
            ...
            var d =  JsonConvert.SerializeObject(
                ...
                select new LinkDto
                {
                    ...
                    Settings = JsonConvert.SerializeObject(link.Settings)
                },
...
public class LinkDisplayWithSettings : LinkDisplay
{
    [DataMember(Name = "settings")]
